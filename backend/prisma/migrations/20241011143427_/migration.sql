/*
  ...
  - The `id` column on the `SaveSocialLinks` table would be dropped and recreated. This will lead to data loss if there is data in the column.
...
ADD CONSTRAINT "SaveSocialLinks_pkey" PRIMARY KEY ("id");
